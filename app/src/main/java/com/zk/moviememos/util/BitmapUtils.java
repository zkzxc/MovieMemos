...
public class BitmapUtils {
     ...
     * 设置位图的饱和度
     *
     * @param srcBitmap 要被处理的位图
     * @param sat       设置的饱和度值，0为最低，即黑白图像，1为原图，越大饱和度越高
     * @return
     */
     ...
     *
     * @param srcBitmap 要被处理的位图
     * @param brightness    设置的亮度值，0为原图，负数为降低亮度，正数为增加亮度
     * @return
     */
     ...
     * 设置位图的对比度
     * @param srcBitmap 要被处理的位图
     * @param contrast   设置的对比度值，0为最低，即黑白图像，1为原图，越大饱和度越高
     * @return
     */
    ...
    /**
     * 用FastBlur算法对位图进行模糊处理
     *
     * @param sentBitmap       要被模糊处理的位图
     * @param radius           模糊半径
     * @param canReuseInBitmap 是否在原图上修改
     * @return
     */
