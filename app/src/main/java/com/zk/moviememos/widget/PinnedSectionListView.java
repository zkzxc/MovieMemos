...
public class PinnedSectionListView extends ListView {
    ...
    void createPinnedShadow(int position) {
        ...
        // 修改margin
        RelativeLayout rl = (RelativeLayout) pinnedView.findViewById(R.id.rl_section_content);
        ViewGroup.MarginLayoutParams mlp = (MarginLayoutParams) rl.getLayoutParams();
        mlp.setMargins(0, 0, 0, 0);
        rl.setLayoutParams(mlp);
