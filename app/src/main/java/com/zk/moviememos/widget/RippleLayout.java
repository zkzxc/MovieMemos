...
public class RippleLayout extends RelativeLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.RippleLayout_ripple_color, Color.LTGRAY);
        mDuration = typedArray.getInteger(R.styleable.RippleLayout_duration,
                DEFAULT_DURATION);
        mFrameRate = typedArray
                .getInteger(R.styleable.RippleLayout_framerate, DEFAULT_FRAME_RATE);
        mColorAlpha = typedArray.getInteger(R.styleable.RippleLayout_alpha, DEFAULT_ALPHA);
        mCircleScale = typedArray.getFloat(R.styleable.RippleLayout_scale, DEFAULT_SCALE);
